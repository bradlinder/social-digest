        ...
        <section className="bg-slate-800/40 border border-slate-700/60 rounded-xl p-5 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
            ...
            <div className="bg-slate-900/60 border border-slate-700/40 rounded-lg p-3.5 space-y-1.5">
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                Bluesky (AT Protocol) &amp; Mastodon (ActivityPub) fetchers, plus native card HTML generation with live engagement counters and deep links.
              </p>
            </div>
            ...
            <div className="bg-slate-900/60 border border-slate-700/40 rounded-lg p-3.5 space-y-1.5">
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                Cached OpenGraph scrapers (SSRF-protected), WebP/AVIF media sideloaders, text/hashtag cleaners, and automated excerpt builder.
              </p>
            </div>
